              ...
              <div class="row">
                  ...
                  <div class="dropdown">
                      ...
                      <ul class="dropdown-menu rounded-0 bg-dark">
                          <li @click="setFont(16)"><a class="dropdown-item text-white" href="#"><small class="fw-bold">16px</small></a></li>
                          <li @click="setFont(18)"><a class="dropdown-item text-white" href="#"><small class="fw-bold">18px</small></a></li>
                          <li @click="setFont(20)"><a class="dropdown-item text-white" href="#"><small class="fw-bold">20px</small></a></li>
                          <li @click="setFont(22)"><a class="dropdown-item text-white" href="#"><small class="fw-bold">22px</small></a></li>
                      </ul>
                  </div>
